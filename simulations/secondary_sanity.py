...
single_alpha_run(alpha=0.3, beta=0, strategy_sim=hashplus_sample, difference=0.01, times=4, debug_flag=True, end_lambda=0.5)
single_alpha_run(alpha=0.3, beta=0, strategy_sim=hashplus_sample, difference=0.01, times=4, debug_flag=True, end_lambda=0.015625)
single_alpha_run(alpha=0.3, beta=0, strategy_sim=hashplus_sample, difference=0.01, times=4, debug_flag=True, end_lambda=0.125)
single_alpha_run(alpha=0.3, beta=0, strategy_sim=hashplus_sample, difference=0.01, times=4, debug_flag=True, end_lambda=0.25)
